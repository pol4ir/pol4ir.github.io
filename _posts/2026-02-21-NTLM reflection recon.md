...
As there seems to be no reliable detection method beyond UBR-based checks was available, I ended up writing a <a href="">script</a> to perform detection in a more consistent way. 
